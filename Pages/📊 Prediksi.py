...
# Define a different Lottie animation URL
lottie_animation_url = "https://lottie.host/a4d91214-4b44-49f1-bdba-9f33a82a1ded/FtAmmTGe5W.json"
...
with st.expander("Buat Prediksi", expanded=True):
    ...
    transferred = st.radio(label="Pilih apakah hari libur dipindahkan atau tidak", options=[
...
if show_prediction_message:
    st.write(
        "DataFrame yang berisi masukan dan perkiraan penjualan Anda ditunjukkan di bawah ini:")
